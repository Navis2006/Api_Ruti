...
-- Tiempo de generación: 29-10-2025 a las 14:10:43
...
--
-- Base de datos: `if0_39437187_Rutitruck`
--
...
INSERT INTO `alertas` (`alerta_id`, `ruta_id`, `descripcion`, `tipo_alerta`, `ubicacion_geom`, `creado_por_usuario_id`) VALUES
(2, 2, 'Tramo con muchos baches peligrosos después de pasar el pueblo de Kantunil. Reducir velocidad.', 'Baches Peligrosos', 0x000000000101000000a4703d0ad73b56c0d7a3703d0ad73440, 15),
(3, 3, 'La entrada a la zona hotelera es muy angosta y con tráfico de autobuses. Maniobrar con cuidado.', 'Calle angosta', 0x00000000010100000021b0726891b155c06f1283c0ca213540, 2),
(4, 4, 'Calle cerrada para maniobras de carga de 8 a 10 AM. Planificar ruta alterna.', 'Restricción de Horario', 0x000000000101000000a4703d0ad76756c0295c8fc2f5f83440, 18),
(5, 5, 'Al llegar a la planta, reportarse en la caseta 2. La entrada de proveedores es por la parte trasera.', 'Punto de Descarga Específico', 0x000000000101000000a245b6f3fd6c56c0448b6ce7fbe93440, 5),
(6, 6, 'Cable de luz muy bajo al dar vuelta en esta esquina. Pasar pegado a la derecha.', 'Cable bajo', 0x00000000010100000014ae47e17ac455c00000000000a03440, 22),
(7, 7, 'Báscula de la SCT a la salida del periférico. Verificar que el peso sea correcto.', 'Báscula de Inspección', 0x0000000001010000008b6ce7fba96956c048e17a14aee73440, 7),
(8, 8, 'Topes muy altos y sin pintar en el pueblo de Pomuch. Cruzar despacio.', 'Topes Peligrosos', 0x000000000101000000b29defa7c68b56c008ac1c5a64fb3340, 25),
(9, 9, 'Zona de neblina densa por las mañanas, especialmente en invierno. Encender luces.', 'Condición Climática Frecuente', 0x00000000010100000052b81e85eb1156c0cdcccccccc8c3240, 9),
(10, 10, 'El patio de maniobras es de terracería y se encharca mucho con la lluvia.', 'Terreno Difícil', 0x000000000101000000b29defa7c66356c0931804560eed3440, 31),
(11, 11, 'Curva muy cerrada y peligrosa al entrar a Sucilá.', 'Curva Peligrosa', 0x000000000101000000910f7a36ab1256c0dcd7817346243540, 1),
(12, 12, 'Obras del Tren Maya, un solo carril habilitado por 5 km. Posibles retrasos.', 'Zona de Maniobras', 0x0000000001010000009a99999999f955c0fca9f1d24de23440, 14),
(13, 13, 'Acceso a la zona residencial con pluma. Anunciarse como proveedor.', 'Punto de Acceso Controlado', 0x0000000001010000006abc7493185456c0d7a3703d0a573540, 19),
(14, 14, 'No hay espacio para estacionarse frente al hospital. Usar la bahía de descarga rápida.', 'Zona de No Estacionarse', 0x000000000101000000c976be9f1a6756c04260e5d022fb3440, 4),
(15, 15, 'Entrada de proveedores en la parte trasera del hotel. Hay que rodear la manzana.', 'Punto de Descarga Específico', 0x000000000101000000cdccccccccc455c054e3a59bc4a03440, 28),
(16, 16, 'La rampa de acceso a la terminal es muy pronunciada.', 'Pendiente Pronunciada', 0x0000000001010000003333333333c755c017d9cef753933440, 20),
(17, 17, 'Retén del ejército en el límite estatal. Revisión puede tomar tiempo.', 'Retén Policial Frecuente', 0x0000000001010000003f575bb1bfc056c08a8ee4f21f823240, 33),
(18, 18, 'Calle de un solo sentido, el GPS a veces marca mal la entrada.', 'Sentido de la Vía', 0x0000000001010000007b14ae47e10256c08716d9cef7933340, 8),
(19, 19, 'Corrales de cuarentena. Seguir protocolo de la SAGARPA.', 'Inspección Sanitaria', 0x000000000101000000ac1c5a643baf56c05c8fc2f5289c3240, 36),
(20, 20, 'La entrada a la obra es un camino de terracería. Acceso complicado después de lluvia.', 'Terreno Difícil', 0x000000000101000000d34d621058a156c01904560e2dd23340, 40),
(21, 21, 'El espacio en la aduana del puerto es muy reducido para dar la vuelta.', 'Espacio de Maniobra Reducido', 0x000000000101000000d122dbf97e6a56c0f0a7c64b37493540, 1),
(22, 22, 'Mercado sobre ruedas los domingos. Calle cerrada.', 'Cierre de Vía Programado', 0x000000000101000000a245b6f3fd5c56c0aaf1d24d62d03440, 42),
(23, 23, 'Puente \"El Zacatal\" a veces cierra por vientos fuertes.', 'Posible Cierre de Vía', 0x00000000010100000014ae47e17af456c01f85eb51b89e3240, 13),
(24, 24, 'Báscula de la recicladora a la entrada. Vehículo debe pesarse antes de descargar.', 'Báscula de Inspección', 0x000000000101000000dd240681956b56c0fa7e6abc74f33440, 17),
(25, 25, 'Zona escolar. Reducir velocidad de 7 a 9 AM y de 1 a 3 PM.', 'Zona Escolar', 0x000000000101000000022b8716d96656c00e2db29def073540, 21),
(26, 26, 'Carretera angosta y con muchas curvas. No rebasar.', 'Carretera Angosta', 0x00000000010100000033333333337356c06666666666e63340, 30),
(27, 27, 'Descarga solo por la mañana (antes de las 12 PM).', 'Restricción de Horario', 0x000000000101000000068195438b0c56c0560e2db29daf3440, 34),
(28, 28, 'Caseta de cobro de la autopista a Cancún.', 'Punto de Peaje', 0x000000000101000000713d0ad7a31056c07b14ae47e1ba3440, 8),
(29, 29, 'La calle principal de Izamal es muy angosta. Cuidado con los coches de caballos.', 'Calle angosta', 0x000000000101000000fed478e9264156c0022b8716d9ee3440, 45),
(30, 30, 'Punto de revisión sanitaria para productos del mar.', 'Inspección Sanitaria', 0x000000000101000000295c8fc2f59856c05c8fc2f528dc3440, 50),
(31, 31, 'Prohibido el paso a vehículos de carga pesada de 8 PM a 6 AM.', 'Restricción de Horario', 0x0000000001010000001904560e2d5256c046b6f3fdd4183540, 1),
(32, 32, 'Entregar la mercancía en el andén 3 de la bodega de frío.', 'Punto de Descarga Específico', 0x000000000101000000fca9f1d24d6256c0a01a2fdd24663440, 12),
(33, 33, 'El camino para llegar a la subestación no está pavimentado.', 'Terreno Difícil', 0x000000000101000000d34d6210585956c0c74b378941003540, 16),
(34, 34, 'El ferry a Holbox no transporta vehículos pesados. La descarga es en el muelle.', 'Punto de Entrega Especial', 0x0000000001010000003f355eba49e455c02db29defa7863540, 23),
(35, 35, 'Acceso restringido. Llamar al cliente 30 minutos antes de llegar.', 'Punto de Acceso Controlado', 0x000000000101000000e7fba9f1d26956c0fed478e926113540, 29),
(36, 36, 'Presencia de ganado suelto en la carretera por la noche.', 'Peligro en la Vía', 0x0000000001010000001904560e2d5256c0fa7e6abc74333440, 32),
(37, 37, 'La entrada a la cervecería es por la puerta de proveedores, no la principal.', 'Punto de Descarga Específico', 0x000000000101000000f2d24d62107856c03108ac1c5a043540, 38),
(38, 38, 'Al llegar al supermercado, usar la rampa subterránea para descarga.', 'Entrada Subterránea', 0x000000000101000000dbf97e6abcc455c08d976e1283a03440, 41),
(39, 39, 'La imprenta no tiene montacargas. El operador debe ayudar en la descarga.', 'Requiere Maniobra Manual', 0x000000000101000000fca9f1d24da256c0dbf97e6abcd43340, 9),
(40, 40, 'Zona de topes y boyas. Velocidad máxima 30 km/h.', 'Topes Peligrosos', 0x000000000101000000068195438bb455c0b29defa7c62b3540, 44),
(41, 41, 'Uso obligatorio de casco y chaleco para ingresar a la planta.', 'Equipo de Seguridad Obligatorio', 0x0000000001010000005839b4c8766656c060e5d022dbd93440, 1),
(42, 42, 'Aduana en la terminal de carga aérea. Proceso puede ser lento.', 'Trámite Aduanal', 0x000000000101000000273108ac1c6a56c01d5a643bdfef3440, 15),
(43, 43, 'En Motul, cuidado con las bicicletas y triciclos en el centro.', 'Tráfico Local Intenso', 0x000000000101000000a01a2fdd245256c0295c8fc2f5183540, 24),
(44, 44, 'La rampa de la maquiladora tiene una inclinación del 15%.', 'Pendiente Pronunciada', 0x000000000101000000f2d24d62107056c0a8c64b3789e13440, 27);
...
(1, 1, 1, 'activo', 'Carlos', 'Gutiérrez Pérez', 'carlos.gutierrez@transportesrapidos.com', '$2a$12$4rY.gPS9jPz3.L0V2ZfaPuzf1e9.E7mJd.2y3i.gK3.O4h.2L9.p6', '2025-10-10 00:14:26'),
(2, 2, 1, 'activo', 'Ana', 'Martínez López', 'ana.martinez@logisticapeninsular.net', '$2a$12$4rY.gPS9jPz3.L0V2ZfaPuzf1e9.E7mJd.2y3i.gK3.O4h.2L9.p6', '2025-10-10 00:14:26'),
...
(1, 1, 'El Conquistador', '45-AB-1C', 'Torton', 'en_servicio', '4.15', '2.60', '12.50', '18.50'),
...
(34, 34, NULL, '78-NO-4D', 'Lowboy (Cama Baja)', 'en_servicio', '3.50', '3.00', '18.00', '40.00'),
...
CREATE TABLE `viajes` (
  ...
  `ruta_id` int(11) NOT NULL,
  `operador_usuario_id` int(11) NOT NULL,
  `vehiculo_id` int(11) NOT NULL,
  `asignado_por_usuario_id` int(11) NOT NULL,
...
(45, 45, 15, 45, 5, 'Asignado', '2025-10-10 00:14:26', NULL, NULL),
...
(52, 2, 54, 28, 22, 'Planeado', '2025-10-10 16:24:19', '2025-10-10 17:24:00', '2025-10-23 17:24:00');
...
--
ALTER TABLE `alertas`
  MODIFY `alerta_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;

--
-- AUTO_INCREMENT de la tabla `empresas`
--
ALTER TABLE `empresas`
  MODIFY `empresa_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
...
--
ALTER TABLE `rutas`
  MODIFY `ruta_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
...
--
ALTER TABLE `vehiculos`
  MODIFY `vehiculo_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;

--
-- AUTO_INCREMENT de la tabla `viajes`
--
ALTER TABLE `viajes`
  MODIFY `viaje_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
