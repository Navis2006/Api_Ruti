...
<div class="space-y-6">
    <div class="bg-white p-6 rounded-lg shadow-sm">
        ...
        <p class="text-lg"><strong>Teléfono:</strong> <a href="tel:+523398765432" class="text-blue-600 hover:underline">+52 33 9876 5432</a></p>
        <p class="text-lg"><strong>Correo:</strong> <a href="mailto:emergencias@empresa.com" class="text-blue-600 hover:underline">emergencias@empresa.com</a></p>
        <p class="text-sm text-gray-600 mt-2">Para situaciones críticas en ruta o cualquier urgencia.</p>
    </div>

    <div class="bg-white p-6 rounded-lg shadow-sm">
        <h2 class="text-xl font-bold mb-2 text-blue-600">Soporte General</h2>
        <p class="text-gray-700"><strong>Horario:</strong> Lunes a Viernes, 9:00 AM - 6:00 PM</p>
        <p class="text-lg"><strong>Teléfono:</strong> <a href="tel:+523355551122" class="text-blue-600 hover:underline">+52 33 5555 1122</a></p>
        <p class="text-lg"><strong>Correo:</strong> <a href="mailto:soporte@empresa.com" class="text-blue-600 hover:underline">soporte@empresa.com</a></p>
        <p class="text-sm text-gray-600 mt-2">Para preguntas sobre la plataforma, rutas, tráilers o perfil.</p>
    </div>

    <div class="bg-white p-6 rounded-lg shadow-sm">
        <h2 class="text-xl font-bold mb-2 text-blue-600">Soporte Técnico</h2>
        <p class="text-gray-700"><strong>Horario:</strong> Lunes a Viernes, 9:00 AM - 6:00 PM</p>
        <p class="text-lg"><strong>Teléfono:</strong> <a href="tel:+523344443322" class="text-blue-600 hover:underline">+52 33 4444 3322</a></p>
        <p class="text-lg"><strong>Correo:</strong> <a href="mailto:tecnico@empresa.com" class="text-blue-600 hover:underline">tecnico@empresa.com</a></p>
